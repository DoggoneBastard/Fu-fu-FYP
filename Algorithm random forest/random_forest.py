...
def main():
    ...
    if not (os.path.exists(models_dir) and os.path.exists(data_path)):
        ...
        print("Please ensure you have run the 'train_rf_models.py' script first.")
        return

    # Load the trained models
    try:
        model_v = joblib.load(os.path.join(models_dir, 'Viability_model_rf.joblib'))
        model_r = joblib.load(os.path.join(models_dir, 'Recovery_model_rf.joblib'))
    ...
    output_path = 'best_rf_results.csv'
